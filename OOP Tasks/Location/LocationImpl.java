...
public class LocationImpl implements Location {
    ...
    public String getParentName() {
        return parent != null && !parent.getName().equals("") ? parent.getName() : "--";
    }
    ...
    public Location getTopLocation() {
        return parent != null && !parent.getName().equals("") ? parent.getTopLocation() : this;
    }
    ...
    public boolean isCorrect() {
        return this.getParentName().equals("--") || this.parent.getType().compareTo(this.getType()) < 0 && parent.isCorrect();
    }
    ...
    public String getAddress() {
        String address;
        address = (name.endsWith(".") || name.substring(0, name.indexOf(" ")).contains(".")) ? name : type.getNameForAddress() + name;
